...
<ul>
  ...
  "a href="https://example.com" target="_blank" rel="noopener noreferrer">Example</a", <br> required more effort compared to Markdown links which are simpler to write even manually: <br>[Example.com](https://example.com); </ul>
  <ul>
